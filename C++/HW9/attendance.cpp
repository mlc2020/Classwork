...
//std::string classnum = "551";
//std::string uin = "427002841";
//Date date1 = Date(2019,8,5,4,40,40);
//Date date2 = Date(2019,4,3,6,20,4);
//    auto ar1 = AttendanceRecord(classnum, uin, date1);
//    auto ar2 = AttendanceRecord(classnum, uin, date2);
//    auto course = Course(classnum, "Yo", date1, date2);
//    course.addAttendanceRecord(ar1);
//    course.addAttendanceRecord(ar2);
}
